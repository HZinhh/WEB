let productData = [
  ...
  },
  {
    ...
    img: "./img/SP/0007.jpg",
    description:
      "Sữa rửa mặt trà xanh innisfree Green Tea Amino Cleansing Foam làm sạch tạp chất, đồng thời dưỡng ẩm để làn da sạch sẽ, mịn màng.",
    remain: 0,
    price: 260000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0010.jpg",
    description:
      "Son dưỡng ẩm sâu không màu. Innisfree Canola Honey Lip Balm Deep Moisture 3.5g. Son dưỡng ẩm sâu không màu Innisfree Canola Honey Lip Balm Deep Moisture chiết xuất từ mật ong hoa cải giúp dưỡng ẩm sâu, tăng độ đàn hồi và hình thành màng chắn bảo vệ đôi môi.",
    remain: 0,
    price: 130000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0012.jpg",
    description:
      "Tinh chất bạc hà tươi mát sẽ mang đến cho bạn một trải nghiệm hoàn toàn mới với dòng mặt nạ bạc hà đến từ Innisfree. Sản phẩm mang đậm phong cách của Innisfree với thiết kế thân thiện với môi trường, thành phần chiết xuất hoàn toàn từ lá bạc hà được trồng trên đảo Jeju thần thánh và được hứa hẹn sẽ là một best seller mới của hãng.",
    remain: 50,
    price: 240000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0013.jpg",
    description:
      "Mặt nạ tinh chất hoa hồng Innisfree Rose My Real Squeeze Mask là mặt nạ được chiết xuất từ hoa hồng thiên nhiên có tác dụng giúp cung cấp ẩm cho làn da mịn màng, căng da và chống lại sự lão hóa của da.",
    remain: 50,
    price: 240000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0014.jpg",
    description:
      "Kem chống nắng innisfree Tone Up No Sebum Sunscreen EX SPF 50+ PA++++ với màng lọc chống nắng vật lý, giúp bảo vệ da tối ưu, đồng thời mang lại hiệu quả nâng tông, kiềm dầu vượt trội, duy trì làn da hồng hào, mịn mượt suốt 24 giờ.",
    remain: 0,
    price: 330000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0016.jpg",
    description:
      "Innisfree Real Fit Matte Liquid là dòng son kem lì dạng lỏng, nó là sự kết hợp đặc sắc giữa son lì và son bóng. Innisfree Real Fit Matte Liquid có chất son lên môi rất mịn, cực mượt và mềm, không hề gây bí hay nặng môi, đặc biệt màu son giữ được khá lâu trên môi. Son có chứa dưỡng chất dưỡng ẩm cho môi nên không hề gây khô môi hay bợn màu.",
    remain: 50,
    price: 190000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0018.jpg",
    description:
      "Cung cấp dưỡng chất dưỡng ẩm gấp 30 lần tinh chất dưỡng thông thường chỉ sau 1 lần sử dụng.",
    remain: 0,
    price: 195000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0023.jpg",
    description:
      "Sữa Dưỡng Trắng Da Hada Labo Perfect White Arbutin Milk là dòng sữa dưỡng thuộc thương hiệu Hadalabo. Với công thức kết hợp giữa thành phần Arbutin tinh khiết và Hyaluronic Acid nuôi dưỡng làn da trắng sáng vượt trội kết hợp cấp ẩm sâu, mang lại làn da sáng mịn đều màu và ẩm mượt dài lâu",
    remain: 50,
    price: 200000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0024.jpg",
    description:
      "GEL dưỡng ẩm chống nắng 5-in-1 có khả năng thay thế chức năng của lotion dưỡng, tinh chất dưỡng, kem dưỡng, kem lót và kem chống nắng.",
    remain: 50,
    price: 280000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0025.jpg",
    description:
      "Sạch sâu 99% lớp trang điểm lâu trôi, kem chống nắng, bụi mịn PM2.5 và dưỡng trắng.",
    remain: 50,
    price: 180000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0028.jpg",
    description:
      "Phấn Nền Dạng Nén Che Phủ Hoàn Hảo, Kiềm Dầu Hiệu Quả Maybelline Fit Me Matte Poreless Powder SPF32 /PA+++ là phấn nền đến từ thương hiệu Maybelline công thức chứa hạt phấn Micro Power cho lớp nền mịn, kiềm dầu lên đến 16h, mang đến cho bạn một lớp nền hoàn hảo, phủ mịn và không bị bóng dầu.",
    remain: 0,
    price: 220000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0029.jpg",
    description:
      "Phấn Nén Mịn Lì Kiềm Dầu Maybelline Fit Me Matte + Poreless Powder Oil Control SPF 32 PA+++ là một trong những loại phấn nén có khả năng che phủ, kiềm dầu đồng thời còn chứa các dưỡng chất giúp giữ ẩm cho da và giúp da trở nên sáng mịn.",
    remain: 50,
    price: 200000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0032.jpg",
    description:
      "Phấn Má Hồng Mịn Da Maybelline Fit Me Blush là bộ sản phẩm phấn má hồng mịn da với màu sắc nhẹ nhàng trẻ trung và có tác dụng kiềm dầu, giữ cho khuôn mặt của bạn khô thoáng, ko bị bóng nhờn. Hộp phấn có thiết kế bắt mắt và màu sắc xinh tươi, là sản phẩm má hồng được ưa chuộng của nhiều bạn gái, mang đến gương mặt tươi tắn tự nhiên mỗi ngày.",
    remain: 50,
    price: 150000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0033.jpg",
    description:
      "Trong khi các loại kem che khuyết điểm màu khác đều khá khó khăn để bạn có thể bắt đầu sử dụng, thì với bảng màu Face Studio Master Camo Color Correcting Kit này, các bạn có thể thực hiện đơn giản hơn với việc che phủ đi các nốt mụn, thâm hay tàn nhang đáng ghét nhé!",
    remain: 0,
    price: 150000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0034.jpg",
    description:
      "Bút cushion che khuyết điểm Instant Age giúp che phủ hoàn hảo các loại khuyết điểm và giúp giảm bọng mắt, quầng thâm. Có đến 5 màu phù hợp mọi tông da và undertone.",
    remain: 50,
    price: 230000,
    status: 1,
  },
  {
    ...
    img: "./img/SP/0035.jpg",
    description:
      "Thiết kế của Bảng Màu Mắt Tông Hồng Nude The Blushed Nudes Maybelline góc cạnh với chất liệu nhựa phun sơn nhũ cứng cáp cho cảm giác cầm chắc tay. Sản phẩm còn kèm theo gương trang điểm và 2 cây cọ 2 đầu chuyên dụng để đánh phấn mắt, thuận tiện cho các cô nàng khi đi du lịch.",
    remain: 50,
    price: 314000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0037.jpg",
    description:
      "Bút Kẻ Mắt Nước Maybelline Hyper Ink với công thức cải tiến sở hữu đầu cọ bút dạ – cushion chắc chắn, sẽ giúp bạn có đôi mắt quyến rũ hơn. Công nghệ film hút sáng cho màu mực đen đậm cá tính x10 lần. Kẻ mắt nước Maybelline Hyper Ink không lem, không trôi suốt 24 giờ nhưng lại hoàn toàn dễ tẩy trang.",
    remain: 50,
    price: 170000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0041.jpg",
    description:
      "Son Kem Lì 16H Lâu Trôi SuperStay Matte Ink™ nổi tiếng với công nghệ mực đàn hồi độc quyền giúp son lên màu chuẩn, lâu trôi 16h, không lem, dính và không gây khô môi, giúp bạn ăn uống, hoạt động thả ga cả ngày dài mà không lo lem, dính trên thành ly, đồ ăn hay quần áo.",
    remain: 50,
    price: 210000,
    status: 1,
  },
  ...
  },
  {
    ...
    img: "./img/SP/0043.jpg",
    description:
      "Son màu lâu phai Vivid Maybelline với tinh chất mật ong dưỡng chất làm cho môi trở nên đàn hồi và mềm mại, mang đến bờ môi ẩm mượt suốt ngày dài. Với sắc tố màu nguyên chất giúp cho màu son lên màu chuẩn, bao phủ tuyệt vời, giữ màu trong suốt 6 giờ.",
    remain: 50,
    price: 190000,
    status: 1,
  },
  ...
  },
  {
    ...
    type: "Son môi",
    description:
      "Hộp quà Perfect Diary với 4 thỏi son kem đa dạng màu sắc sẽ là món quà tuyệt vời dành cho bạn gái của bạn. Bên cạnh việc làm đẹp cho đôi môi, sản phẩm còn được thiết kế với kiểu dáng xinh xắn, gọn nhẹ và tiện lợi để mang theo bên mình khi đi ra ngoài.",
  ...
  },
  {
    ...
    type: "Combo",
    description:
      "Bộ Son môi nhung lì, độ lên màu cao, phiên bản mùa đông và Bảng phấn mắt có sắc tố cao Perfect Diary là lựa chọn hoàn hảo để tạo ra vẻ đẹp tự nhiên và quyến rũ. Với son môi lì độ cao và bảng phấn mắt với sắc tố cao, sản phẩm sẽ giúp bạn tạo ra những trang điểm đầy sáng tạo và ấn tượng.",
  ...
  },
  {
    ...
    type: "Kem dưỡng",
    description:
      "Kem Dưỡng Giúp Phục Hồi Da Đa Công Dụng La Roche-Posay Cicaplast Baume B5+ Combo Kem Dưỡng Cicaplast Baume B5+ Ultra-Repairing Soothing Balm 40ml + Xịt Khoáng Thermal Spring Water 50ml",
    img: "./img/SP/0051.jpg",
    price: 280000,
    remain: 0,
    status: 1,
  },
  {
    ...
    type: "Kẻ mày",
    description:
      "Chì Kẻ Mắt Dạng Sáp Nét Mảnh, Lâu Trôi Romand Han All Shade Liner là chì kẻ mắt đến từ thương hiệu Romand giúp tạo đường viền mắt sắc sảo, chì kẻ có nét vẽ thanh mảnh cùng bảng màu tự nhiên và là bước trang điểm cần thiết cho bạn để sở hữu đôi mắt long lanh tự nhiên không kém phần thu hút. ",
    img: "./img/SP/0052.jpg",
    price: 129000,
    remain: 50,
    status: 1,
  },
  {
    ...
    type: "Son môi",
    description:
      "Son Kem Lì Romand Milk Tea Velvet Tint  là son kem lì của thương hiệu Romand có chất son xốp mịn, độ lên màu chuẩn, dễ tán đều trên môi cùng bảng màu ngọt ngào, mùi thơm dịu nhẹ tựa ly trà sữa hương socola ngọt ngào, êm dịu cho bạn đôi môi ngọt ngào, xinh xắn thu hút mọi ánh nhìn.",
    img: "./img/SP/0053.jpg",
    price: 139000,
    remain: 50,
    status: 1,
  },
  {
    ...
    type: "Cushion",
    description:
      "Phấn Nước Trang Điểm Che Phủ Tự Nhiên, Dưỡng Ẩm Cho Da Căng Bóng Romand Bare Water Cushion là phấn nước trang điểm đến từ thương hiệu Romand có kết cấu chất phấn mỏng nhẹ tự nhiên, khả năng che phủ hoàn hảo cho làn da ẩm mượt, căng bóng, duy trì lớp nền rạng rỡ suốt cả ngày dài.",
    img: "./img/SP/0054.jpg",
    price: 159000,
    remain: 0,
    status: 1,
  },
  {
    ...
    type: "Phấn mắt",
    description:
      "Bảng Phấn Mắt 6 Ô Siêu Xinh Bbia Ready To Wear Eye Palette là phấn mắt của thương hiệu Bbia với thiết kế bảng màu 6 ô xinh xắn, chất phấn mướt mịn, độ lên màu và bám màu tốt giúp cho bạn sở hữu đôi mắt long lanh cùng nhũ lấp lánh cực kỳ cuốn hút.",
    img: "./img/SP/0055.jpg",
    price: 259000,
    remain: 50,
    status: 1,
  ...
  },
  {
    ...
    type: "Eyeliner",
    description:
      "Bút Kẻ Mắt Nước Chống Trôi Hiệu Quả Cho Đôi Mắt Sắc Nét Merzy The Heritage Pen Eyeliner là kẻ mắt nước nằm trong bộ sưu tập được thương hiệu Merzy ấp ủ đã lâu với tên gọi The Heritage Collection dễ dàng hoàn thiện đường kẻ mắt chỉ với một lần kẻ cùng khả năng chống thấm nước mạnh mẽ cho đôi mắt thêm phần sắc nét huyền bí và cuốn hút.",
    img: "./img/SP/0059.jpg",
    price: 99000,
    remain: 0,
    status: 1,
...
onload = () => {
  ...
  else productData = JSON.parse(localStorage.getItem("productDatabase"));
...
function loadBang(search = "") {
  ...
  for (let i = 0; i < productData.length; i++)
    if (
      search === "" ||
      productData[i].name.toLowerCase().includes(search.toLowerCase())
    )
      dong += `            
                <tr>
                    ...
                    <td>
                        <button class="btn btn-warning" onclick="openForm('Sửa', ${
                          productData[i].id
                        })">Sửa</button><br>
                            ...
                            <div class="row m-0">
                                <div class="col">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="1000" step="500" class="form-control" id="product-price" value="${
                                          product.price || ""
                                        }" onkeyup="checkKey(this, event)" readonly>
...
<label for="product-remain" class="col-form-label fw-bold">Tồn kho:</label>
                                        <input type="number" min="0" step="1" class="form-control" id="product-remain" value="${
                                          product.remain >= 0
                                            ? product.remain
                                            : ""
                                        }" onkeyup="checkKey(this, event)" readonly>
                                ...
                                <div>
                                    ...
                                    <input type="hidden" id="product-img" value="${
                                      product.img || ""
                                    }">
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control" id="product-description" rows="6">${
                                      product.description || ""
                                    }</textarea>
  ...
  if (handle === "Sửa")
    document.getElementById("product-id").setAttribute("readonly", "true");
}
...
function handleProduct(handle, index = 0) {
  ...
  if (document.getElementById("product-id").value === "") {
    ...
    !document.getElementById("product-id").hasAttribute("readonly") &&
    getProduct(document.getElementById("product-id").value) !== -1
  ) {
  ...
  if (document.getElementById("product-remain").value === "") {
    document.getElementById("remain-error").innerHTML =
      "Tồn kho không được trống";
    error = true;
  }
  ...
  document.querySelector(
    ".alert-success"
  ).innerHTML = `${handle} sản phẩm thành công`;
...
function updateSoLuong(id, soLuong) {
  ...
  productData[getProduct(id)].remain =
    Number(productData[getProduct(id)].remain) + Number(soLuong);
  localStorage.setItem("productDatabase", JSON.stringify(productData));
}
