document.querySelector(".left").innerHTML = `
  <div class="nav-list">
    ...
    <a href="./import.html" class="btn btn-left py-3 ps-2 import"><i class="bi bi-file-earmark-arrow-down-fill"></i> PHIẾU NHẬP</a>
    <a href="./price.html" class="btn btn-left py-3 ps-2 price"><i class="bi bi-currency-exchange"></i> GIÁ BÁN</a>
...
document
  ...
  .setAttribute(
    "style",
    "background-color: var(--bs-danger-bg-subtle); color: #212529; font-weight: bold; width: 100%"
  );
...
buttons.forEach((button) => {
  button.addEventListener("mouseover", () => {
    document
      ...
      .setAttribute(
        "style",
        "background-color: #212529; font-weight: normal; color: white; width: 80%"
      );
    button.setAttribute(
      "style",
      "background-color: var(--bs-danger-bg-subtle); color: #212529; font-weight: bold; width: 100%"
